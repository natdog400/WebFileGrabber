...
class SwfSaver:
    def __init__(self, outdir, host_filter, host_includes, host_excludes, includes, excludes, ct_includes, mirror):
        self.outdir = outdir
...
def build_addon(args):
    ...
    mirror = (str(mirror) == '1')
    return [SwfSaver(outdir, host, host_includes, host_excludes, includes, excludes, ct_includes, mirror)]
